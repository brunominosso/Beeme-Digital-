...
export default async function ConteudosPage() {
  ...
  const SM_STATUSES   = ['sm_novo', 'design_fila', 'design_fazendo', 'sm_revisao', 'cliente_aprovacao', 'sm_aprovado', 'sm_postado']
  const DES_STATUSES  = ['design_fila', 'design_fazendo', 'design_ajuste']

  const ALL_NEW_STATUSES = ['sm_novo', 'design_fila', 'design_fazendo', 'sm_revisao', 'cliente_aprovacao', 'sm_aprovado', 'sm_postado', 'design_ajuste']
